        ...
        <Grid item xs={12} md={7}>
          <Paper sx={{ p: 3 }}>
            ...
            <Grid container spacing={2}>
              {loadingCards && Array.from({ length: 6 }).map((_, i) => (
                <Grid item key={i} xs={12} sm={6} md={4}><Skeleton variant="rounded" height={90} /></Grid>
              ))}
              ...
              {!loadingCards && companies.length === 0 && (
                <Grid item xs={12}><Typography color="text.secondary">No companies yet.</Typography></Grid>
              )}
            </Grid>
          </Paper>
        </Grid>
